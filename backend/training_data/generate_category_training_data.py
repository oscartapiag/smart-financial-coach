...
seeds = {
    ...
    "Entertainment": [
        ...
        "NFL GAMEPASS", "NBA LEAGUE PASS", "FANDANGO", "iCloud"
    ],
    "Coffee": [
    ...
    "Utilities": [
        "PG&E", "COMCAST", "XFINITY", "AT&T INTERNET", "T-MOBILE", "VERIZON", "AT&T",
        "WATER BILL", "CITY GARBAGE", "ELECTRIC CO-OP", "GAS COMPANY", "SMUD ENERGY",
        "SPECTRUM", "DIRECTV", "ADT SECURITY", "SONIC INTERNET", "WOW INTERNET",
        "FRONTIER COMMUNICATIONS", "CINCINNATI BELL", "COX COMMUNICATIONS", "METRONET", "BILL"
    ],
    "Rent": [
